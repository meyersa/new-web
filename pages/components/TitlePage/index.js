...
export default function TitlePage({ header, image, children, socialLinks = true }) {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {typeof image === "string" ? (
        // Dynamic image
        <Image src={image} alt="Background image" priority={true} quality={25} fill={true} />
      ) : (
        // Static imported image
        <Image src={image || defaultImage} alt="Background image" priority={true} quality={25} fill={true} placeholder="blur" />
      )}{" "}
